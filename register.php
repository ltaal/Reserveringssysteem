...
if(isset($_POST['submit'])) {
    ...
    if($phone_number == '') {
        $errors['phone_number'] = 'Telefoonnummer mag niet leeg zijn.';
    }
    if($password == '') {
    ...
    if(empty($errors)) {
        ...
        $query = "INSERT INTO students (name, phone_number, password) VALUES ('$name', '$phone_number', '$password')";
            ...
            <form class="column is-6" action="" method="post">
                ...
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control has-icons-left">
                                <input class="input" id="phone_number" type="number" name="phone_number" value="<?= $phone_number ?? '' ?>" />
